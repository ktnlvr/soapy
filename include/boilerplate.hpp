...
private:
    ...
    void pickPhysicalDevice() {
        ...
        throw std::runtime_error("No suitable physical device found with transfer & compute queues");
    }
    ...
    void createLogicalDevice() {
        std::set<uint32_t> uniqueQueueFamilies = {transferQueueFamily, computeQueueFamily};
